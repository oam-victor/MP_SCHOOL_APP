...
const handleClick = async (id_: ObjectId) => {
  try {
    const response = await axios.delete(
      `http://3.148.115.155:3000/api/user/${id_}`,
    )
...
export const UserModalDelete = ({ id_ }: UserModalDeleteProps) => {
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to delete this user? All the
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <button
                    ...
                    onClick={() => dispatch(toggleModalUserDelete())}
                    ref={cancelButtonRef}
                  >
                    Cancel
                  </button>
